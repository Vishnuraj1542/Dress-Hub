...
export default function NavBar(){
    return(
        ...
        <ul className='flex flex-row items-center justify-center gap-10 mr-4 text-md font-serif p-2 ml-2 lg:items-center lg:text-2xl lg:gap-15 md:justify-center md:gap-20 md:text-xl'>
